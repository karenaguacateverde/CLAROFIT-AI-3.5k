    ...
    <div className="min-h-dvh bg-[var(--bg)] text-[var(--text-primary)] [font-family:var(--font-body)]">
      ...
      <Solucion
        ...
        antesDespues={{
          labelAntes: 'Antes',
          antes: [
            'Una lista de 47 tareas sin orden ni dueño.',
            'Abrías la app y no sabías por dónde empezar.',
            'El día se te iba en decidir, no en hacer.',
          ],
          labelDespues: 'Después',
          despues: [
            '3 prioridades con su bloque de tiempo, listas a las 8:03.',
            'Sabes exactamente qué sigue, sin pensarlo dos veces.',
            'El día rinde porque ya no decides — ejecutas.',
          ],
        }}
      />
